...
#define ARKUI_NODE_ATTRIBUTE_ENUM_EXPANDING 1
#include "node_attributes/swiper/node_attr_swiper.h"
#undef ARKUI_NODE_ATTRIBUTE_ENUM_EXPANDING
...
#define ARKUI_NODE_EVENT_ENUM_EXPANDING 1
#include "node_attributes/swiper/node_event_swiper.h"
#undef ARKUI_NODE_EVENT_ENUM_EXPANDING
