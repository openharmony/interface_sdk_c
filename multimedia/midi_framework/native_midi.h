 ...
 *
 * @param client Target client handle, which is generated by {@link OH_MIDIClient_Create}.
 * @return {@link #OH_MIDI_STATUS_OK} if execution succeeds.
 ...
 *
 * @param client The MIDI client handle, which is generated by {@link OH_MIDIClient_Create}.
