 ...
 * @return Pointer to the video decoder instance.<br> If the decoder type is not supported or the memory is insufficient, NULL is returned.
 * @since 9
 */
 ...
 * which can be extracted from {@link OH_AVSource}. This function must be called prior to {@link OH_VideoDecoder_Prepare}.
 *
 ...
 *     <br>{@link AV_ERR_UNKNOWN}: An unknown error occurs.
 *     <br>{@link AV_ERR_INVALID_STATE}: The function is called in an incorrect state.
 *     <br>{@link AV_ERR_OPERATE_NOT_PERMIT}: 1. An internal execution error occurs. 2. CSC is configured, but {@link 
...
/**
 * @brief Resets a video decoder. The decoder returns to the initial state. To continue decoding, you must call {@link 
 * OH_VideoDecoder_Configure} to configure the decoder again.
 * 
 * @param codec Pointer to a video decoder instance.
 * @return {@link AV_ERR_OK}: The operation is successful.
 *     <br>{@link AV_ERR_NO_MEMORY}: The decoder instance has been destroyed.
 ...
 *     <br>{@link AV_ERR_UNKNOWN}£º unknown error.
 *     <br>{@link AV_ERR_INVALID_STATE}£º The function is called in an incorrect state.
 *     <br>{@link AV_ERR_OPERATE_NOT_PERMIT}£º not permitted in asynchronous mode.
 *     <br>{@link AV_ERR_TRY_AGAIN_LATER}£º query failed, recommended retry after delay.
 * @since 20
 */
 ...
 *
 * Compared with {@link OH_VideoDecoder_RegisterCallback}, the callback registered by this interface provides
 * more detailed error reasons and recovery actions.
 *
 * @param codec Pointer to an OH_AVCodec instance
 * @param callback A collection of all callback functions, see {@link OH_AVCodecCallbackV2}
 * @param userData User specific data
 * @return Returns AV_ERR_OK if the execution is successful,
 *     otherwise returns a specific error code, refer to {@link OH_AVErrCode}.
 *     <br>{@link AV_ERR_NO_MEMORY}, inner resource has already been released.
 *     <br>{@link AV_ERR_INVALID_VAL}, the decoder is nullptr or invalid.
 *     <br>{@link AV_ERR_UNKNOWN}, unknown error.
 *     <br>{@link AV_ERR_OPERATE_NOT_PERMIT}, internal execution error.
 * @since 26.0.0
 */
