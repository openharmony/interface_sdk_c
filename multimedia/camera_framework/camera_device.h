 ...
 *
 * @brief Defines the basic APIs of the camera device.
 * 
...
/**
 * @brief Obtains the sensor direction of a camera device.
 * 
 * @param camera Pointer to the camera device.
 * @param orientation Pointer to the sensor direction obtained.
 * @return **CAMERA_OK**: The operation is successful.
 *     <br>**CAMERA_CAMERA_INVALID_ARGUMENT**: A parameter is missing or the parameter type is incorrect.
...
/**
 * @brief Obtains the name of a remote device.
 * 
 * @param camera Pointer to the camera device.
 * @param hostDeviceName Double pointer to the name of the remote device.
 * @return **CAMERA_OK**: The operation is successful, and the remote device name is returned.
 *     <br>**CAMERA_CAMERA_INVALID_ARGUMENT**: A parameter is missing or the parameter type is incorrect.
 *     <br>**CAMERA_SERVICE_FATAL_ERROR**: The camera service is abnormal.
 * @since 15
 */
...
/**
 * @brief Obtains the type of a remote device.
 * 
 * @param camera Pointer to the camera device.
 * @param hostDeviceType Pointer to the type of the remote device.
 * @return **CAMERA_OK**: The operation is successful, and the remote device name is returned.
 *     <br>**CAMERA_CAMERA_INVALID_ARGUMENT**: A parameter is missing or the parameter type is incorrect.
 *     <br>**CAMERA_SERVICE_FATAL_ERROR**: The camera service is abnormal.
 * @since 15
