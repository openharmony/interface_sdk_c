...
/**
* @brief Enumerates the Hi-Fi stereo reverberation settings.
*
...
typedef enum OH_AmbAttributeSet {
    /**
* First-order Hi-Fi stereo reverberation.
*
* @since 11
*/
    AMB_ORD_1 = 1ULL << 0U,
    ...
    /**
* Second-order Hi-Fi stereo reverberation.
*
* @since 11
*/
    AMB_ORD_2 = 2ULL << 0U,
    ...
    /**
* Third-order Hi-Fi stereo reverberation.
*
* @since 11
*/
    AMB_ORD_3 = 3ULL << 0U,
    ...
    /**
* Hi-Fi stereo reverberation with ACN channel sorting.
*
* @since 11
*/
    AMB_COM_ACN = 0ULL << 8U,
    ...
    /**
* Hi-Fi stereo reverberation with FUMA channel sorting.
*
* @since 11
*/
    ...
    /**
* N3D normalized Hi-Fi stereo reverberation.
*
* @since 11
*/
    ...
    /**
* SN3D normalized Hi-Fi stereo reverberation.
*
* @since 11
*/
    ...
    /**
* Audio channel layout for Hi-Fi stereo reverberation.
*
* @since 11
*/
    AMB_MODE = 1ULL << 44U
