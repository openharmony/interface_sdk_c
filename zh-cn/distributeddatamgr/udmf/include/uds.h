 ...
 * @return 返回执行的状态代码。
 *     <br>返回UDMF_E_OK表示执行成功。
 *     <br>返回UDMF_E_INVALID_PARAM表示传入了无效参数。
 *     <br>具体请参见{@link Udmf_ErrCode}。
 * @since 26.0.0
 * @see OH_UdsHtml Udmf_ErrCode
 */
 ...
 * <br>当使用{@link OH_UdsDetails_Destroy}销毁字典类型{@link OH_UdsDetails}指针指向的实例对象，该返回值也会被释放。
 * @since 22
 * @see OH_UdsDetails
 */
