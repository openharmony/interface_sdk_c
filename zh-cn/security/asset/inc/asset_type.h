...
typedef enum {
    ...
    /**
     * 表示关键资产需要的用户认证类型，其值为uint32_t类型。
     */
    ASSET_TAG_AUTH_TYPE = ASSET_TYPE_NUMBER | 0x05,

    /**
     * 表示用户认证的有效时间，其值为uint32_t类型，单位为秒。
     */
