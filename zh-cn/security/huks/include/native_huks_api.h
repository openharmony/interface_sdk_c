 ...
 * @{
 *
 * @brief 通用密钥库（HUKS）向应用提供密钥库能力，支持密钥管理和密钥的密码学操作。应用可以导入密钥或者调用HUKS接口生成密钥。
 *
 * @since 9
 * @version 1.0
 */
 ...
 *
 * @brief 声明用于访问通用密钥库（Universal KeyStore，HUKS）的API。
 *
 ...
 * @param paramSetOut 若生成的是临时密钥，此参数存放密钥数据；若生成的是非临时密钥，此参数可为空。
 * @return 可能的返回码（errorCode）：
 *     <br>OH_HUKS_SUCCESS 0：操作成功。
 *     <br>OH_HUKS_ERR_CODE_ILLEGAL_ARGUMENT 401：参数keyAlias、paramSetIn、paramSetOut存在无效参数。
 ...
 * @param key 待导入密钥数据，需符合HUKS的格式要求。
 * @return 可能的返回码（errorCode）：
 *     <br>OH_HUKS_SUCCESS 0：操作成功。
 *     <br>OH_HUKS_ERR_CODE_ILLEGAL_ARGUMENT 401：参数keyAlias、paramSet、key存在无效参数。
 *     <br>OH_HUKS_ERR_CODE_FEATURE_NOT_SUPPORTED 12000001：暂不支持该功能。
 *     <br>OH_HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT 12000002：获取密钥参数失败。
 *     <br>OH_HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT 12000003：密钥参数无效。
 *     <br>OH_HUKS_ERR_CODE_FILE_OPERATION_FAIL 12000004：删除或者写文件失败。
 ...
 *
 * @param keyAlias 待导入密钥的别名，需要保证业务所在进程内唯一，否则会发生覆盖。
 * @param wrappingKeyAlias 密钥别名，该别名对应的密钥必须已存在，用于执行密钥协商或解密数字信封，协商或解密出的密钥进而用于解密待导入密钥。
 * @param paramSet 待导入加密密钥的属性参数。
 * @param wrappedKeyData 需要导入的加密的密钥数据，需要符合HUKS定义的格式，具体见{@link OH_Huks_AlgSuite}。
 * @return 可能的返回码（errorCode）：
 *     <br>OH_HUKS_SUCCESS 0：操作成功。
 *     <br>OH_HUKS_ERR_CODE_ILLEGAL_ARGUMENT 401：参数keyAlias、wrappingKeyAlias、paramSet、wrappedKeyData存在无效参数。
 *     <br>OH_HUKS_ERR_CODE_FEATURE_NOT_SUPPORTED 12000001：暂不支持该功能。
 *     <br>OH_HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT 12000002：获取密钥参数失败。
 *     <br>OH_HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT 12000003：密钥参数无效。
 *     <br>OH_HUKS_ERR_CODE_FILE_OPERATION_FAIL 12000004：删除或者写文件失败。
 ...
 * @return 可能的返回码（errorCode）：
 *     <br>OH_HUKS_SUCCESS 0：操作成功。
 *     <br>OH_HUKS_ERR_CODE_ILLEGAL_ARGUMENT 401：参数keyAlias、paramSet存在无效参数。
 *     <br>OH_HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT 12000002：获取密钥参数失败。
 *     <br>OH_HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT 12000003：密钥参数无效。
 *     <br>OH_HUKS_ERR_CODE_COMMUNICATION_FAIL 12000005：IPC通信失败。
 *     <br>OH_HUKS_ERR_CODE_ITEM_NOT_EXIST 12000011：密钥文件不存在。
 ...
 *     <br>OH_HUKS_ERR_CODE_ILLEGAL_ARGUMENT 401：参数keyAlias、paramSet、certChain存在无效参数。
 *     <br>OH_HUKS_ERR_CODE_FEATURE_NOT_SUPPORTED 12000001：暂不支持该功能。
 *     <br>OH_HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT 12000002：获取密钥参数失败。
 *     <br>OH_HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT 12000003：密钥参数无效。
 *     <br>OH_HUKS_ERR_CODE_COMMUNICATION_FAIL 12000005：IPC通信失败。
...
/**
 * @brief 获取密钥证书链。这是一个涉及网络的耗时接口，调用方可以通过异步线程获取证书链。
 *
 * @param keyAlias 要获取证书的密钥的别名。
 * @param paramSet 获取密钥证书需要的参数。
 * @param certChain 存放输出的密钥证书链。
...
/**
 * @brief 初始化密钥会话接口，并获取一个句柄（必选）和挑战值（可选）。需配合{@link OH_Huks_UpdateSession}、
 * {@link OH_Huks_FinishSession}接口使用，如果操作失败则调用{@link OH_Huks_AbortSession}接口中止会话。
 *
 ...
 * @return 可能的返回码（errorCode）：
 *     <br>OH_HUKS_SUCCESS 0：操作成功。
 *     <br>OH_HUKS_ERR_CODE_ILLEGAL_ARGUMENT 401：参数 keyAlias、paramSet、handle、token存在无效参数。
 *     <br>OH_HUKS_ERR_CODE_FEATURE_NOT_SUPPORTED 12000001：暂不支持该功能。
 *     <br>OH_HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT 12000002：获取密钥参数失败。
 *     <br>OH_HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT 12000003：密钥参数无效。
 *     <br>OH_HUKS_ERR_CODE_COMMUNICATION_FAIL 12000005：IPC通信失败。
...
/**
 * @brief 分段添加密钥操作的数据并进行相应的密钥操作，输出处理数据。需要使用{@link OH_Huks_InitSession}接口生成的句柄来标识会话，
 * 操作完成需要调用{@link OH_Huks_FinishSession}接口结束会话，如果操作失败则调用{@link OH_Huks_AbortSession}接口中止会话。
 *
 ...
 * @return 可能的返回码（errorCode）：
 *     <br>OH_HUKS_SUCCESS 0：操作成功。
 *     <br>OH_HUKS_ERR_CODE_ILLEGAL_ARGUMENT 401：参数handle、paramSet、inData、outData存在无效参数。
 *     <br>OH_HUKS_ERR_CODE_FEATURE_NOT_SUPPORTED 12000001：暂不支持该功能。
 *     <br>OH_HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT 12000002：获取密钥参数失败。
 *     <br>OH_HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT 12000003：密钥参数无效。
 *     <br>OH_HUKS_ERR_CODE_COMMUNICATION_FAIL 12000005：IPC通信失败。
...
/**
 * @brief 结束密钥会话并进行相应的密钥操作，输出处理数据。需要使用{@link OH_Huks_InitSession}接口生成的句柄来标识会话，
 * 如果操作失败则调用{@link OH_Huks_AbortSession}接口中止会话。
 *
 * @param handle 密钥会话句柄，通过{@link OH_Huks_InitSession}接口生成。
 * @param paramSet 密钥操作对应的输入参数集。
...
/**
 * @brief 取消密钥会话。需要使用{@link OH_Huks_InitSession}接口生成的句柄来标识会话。当{@link OH_Huks_InitSession}、
 * {@link OH_Huks_UpdateSession}、{@link OH_Huks_FinishSession}接口操作失败时，需要调用该接口中止会话。
 *
 * @param handle 密钥会话句柄，通过{@link OH_Huks_InitSession}接口生成。
 * @param paramSet 取消密钥会话需要的输入参数集（默认传空）。
 * @return 可能的返回码（errorCode）：
 *     <br>OH_HUKS_SUCCESS 0：操作成功。
 *     <br>OH_HUKS_ERR_CODE_ILLEGAL_ARGUMENT 401：参数handle、paramSet存在无效参数。
 *     <br>OH_HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT 12000002：获取密钥参数失败。
 *     <br>OH_HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT 12000003：密钥参数无效。
 *     <br>OH_HUKS_ERR_CODE_COMMUNICATION_FAIL 12000005：IPC通信失败。
 *     <br>OH_HUKS_ERR_CODE_ITEM_NOT_EXIST 12000011：密钥文件不存在，或handle不存在。
 ...
 * @param outData 获取的密钥别名集，使用之后需要使用{@link OH_Huks_FreeKeyAliasSet}释放系统分配的内存。
 * @return 可能的返回码（errorCode）：
 *     <br>OH_HUKS_SUCCESS 0：操作成功。
 *     <br>OH_HUKS_ERR_CODE_ILLEGAL_ARGUMENT 401：参数paramSet、outData存在无效参数。
 *     <br>OH_HUKS_ERR_CODE_COMMUNICATION_FAIL 12000005：IPC通信失败。
 *     <br>OH_HUKS_ERR_CODE_INTERNAL_ERROR 12000012：设备环境或输入参数异常。
 *     <br>OH_HUKS_ERR_CODE_INSUFFICIENT_MEMORY 12000014：内存不足。
 *     <br>OH_HUKS_ERR_CODE_INVALID_ARGUMENT 12000018：（API 23新增）通过访问群组标签指定的群组名无效。
