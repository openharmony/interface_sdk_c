 ...
 * @{
 *
 * @brief 通用密钥库（HUKS）针对外部密钥管理扩展的能力，包括提供者管理、UKey PIN码管理及其它对应用提供的操作接口。
 *
 * @since 22
 */
 ...
 *
 * @brief 定义面向外部密钥管理扩展的通用密钥库（Universal KeyStore，HUKS）API。
 *
 ...
 *     <br>OH_HUKS_ERR_CODE_INVALID_ARGUMENT 12000018：providerName或paramSet无效。
 *     <br>OH_HUKS_ERR_CODE_ITEM_EXISTS 12000019：提供者已被注册。
 ...
 *     <br>OH_HUKS_ERR_CODE_INSUFFICIENT_MEMORY 12000014：内存不足。
 *     <br>OH_HUKS_ERR_CODE_INVALID_ARGUMENT 12000018：providerName无效。
 * @since 22
 */
 ...
 *     <br>OH_HUKS_ERR_CODE_NOT_SUPPORTED_API 801：不支持的API。
 *     <br>OH_HUKS_ERR_CODE_COMMUNICATION_FAIL 12000005：IPC通信失败。
 *     <br>OH_HUKS_ERR_CODE_CRYPTO_FAIL 12000006：Key驱动报错。
 ...
 *     <br>OH_HUKS_ERR_CODE_INVALID_ARGUMENT 12000018：resourceId或paramSet无效。
 ...
 *     <br>OH_HUKS_ERR_CODE_INTERNAL_ERROR 12000012：发生系统内部错误，处理函数未找到。
 *     <br>OH_HUKS_ERR_CODE_INSUFFICIENT_MEMORY 12000014：内存不足。
 *     <br>OH_HUKS_ERR_CODE_INVALID_ARGUMENT 12000018：resourceId、propertyId、paramSetIn、paramSetOut存在无效参数。
