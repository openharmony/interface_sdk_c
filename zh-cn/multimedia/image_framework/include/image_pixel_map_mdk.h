...
/**
 * @brief 用于描述PixelMap的基本属性信息，包括图片宽高、内存行字节数和像素格式。\n
...
/**
 * @brief 创建PixelMap对象。当前只支持输入流为BGRA格式的流。\n
 * 该接口传入的buf不支持stride。\n
 * 该接口不支持DMA内存。
 *
 * @param env napi的环境指针。
