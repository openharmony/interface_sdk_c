 ...
 * <br>可能的失败原因：
 * <br>1. 输入format为空指针。
 * <br>2. 输入format参数结构校验失败。
 * <br>3. 输入key为空指针。
 * <br>4. 设置的key对应的value类型错误。
 * @since 9
 */
 ...
 * <br>3. 输入key为空指针。
 * <br>4. 输入out为空指针。
 * <br>5. malloc出的out字符串资源不足。
 * <br>6. 获取的key不存在或者未设置。
 * <br>7. 输出out的长度超过256字节。
 * @since 9
 */
