 ...
 * <br>AV_ERR_INVALID_VAL：输入的buffer为空指针或者buffer格式校验失败。
 * <br>AV_ERR_OPERATE_NOT_PERMIT：输入的buffer不是用户创建的。
 * @since 11
 */
 ...
 * <br>1. 输入的buffer或attr为空指针。
 * <br>2. buffer结构校验失败。
 * <br>3. 输入buffer中内存的size或offset是无效值。
 * @since 11
 */
