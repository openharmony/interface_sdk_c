 ...
 * <br>pen为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @return 函数会返回一个指针，指针指向创建的画笔对象副本OH_Drawing_Pen。如果返回值为NULL，表示创建失败；
 * 可能的原因是内存不足，或者是pen为NULL。
 * @since 12
 * @version 1.0
 */
...
/**
 * @brief 设置画笔透明度。画笔在勾勒图形时透明通道会使用该值。
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>pen为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @param alpha 表示要设置的透明度值，是一个8比特的变量，取值范围为[0, 255]，0表示完全透明，255表示完全不透明。
 * @since 11
 * @version 1.0
 */
 ...
 *
 * @param pen 指向OH_Drawing_Pen对象的指针。
 ...
 * @param colorSpaceManager 表示指向OH_NativeColorSpaceManager对象的指针。
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数pen为NULL。
 * @since 20
 * @version 1.0
 */
 ...
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数pen或a为NULL。
 * @since 20
 * @version 1.0
 */
 ...
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数pen或r为NULL。
 * @since 20
 * @version 1.0
 */
 ...
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数pen或g为NULL。
 * @since 20
 * @version 1.0
 */
 ...
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数pen或b为NULL。
 * @since 20
 * @version 1.0
 */
 ...
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @param width 描述画笔厚度的变量，单位为物理像素px，取值范围为float浮点数范围。
 * @since 8
 * @version 1.0
 */
...
/**
 * @brief 用于获取折线尖角的限制值。当画笔绘制折线且转角类型设置为尖角时，该属性用于限制尖角的长度范围；
 * 如果超出限制值则显示为平角，未超出则保持尖角。
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>pen为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
...
/**
 * @brief 用于设置折线尖角的限制值。当画笔绘制折线且转角类型设置为尖角时，该属性用于限制尖角的长度范围；
 * 如果超出限制值则显示为平角，未超出则保持尖角。
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>pen为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
 *
 ...
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>pen为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER；
 * <br>capStyle不在枚举范围内时返回OH_DRAWING_ERROR_PARAMETER_OUT_OF_RANGE。
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 ...
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>pen为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER；
 * <br>joinStyle不在枚举范围内时返回OH_DRAWING_ERROR_PARAMETER_OUT_OF_RANGE。
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @param joinStyle 描述线条转角的样式的枚举类。
 * @since 8
 * @version 1.0
 */
 ...
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @param shaderEffect 指向着色器对象OH_Drawing_ShaderEffect的指针，为NULL表示清空着色器效果。
 * @since 11
 * @version 1.0
 */
 ...
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @param shadowLayer 指向阴影层对象OH_Drawing_ShadowLayer的指针，为NULL表示清空阴影层效果。
 * @since 12
 * @version 1.0
 */
 ...
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @param pathEffect 指向路径效果对象OH_Drawing_PathEffect的指针，为NULL表示清空路径效果。
 * @since 12
 * @version 1.0
 */
 ...
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @param filter 指向滤波器OH_Drawing_Filter的指针，为NULL表示清空画笔滤波器。
 * @since 11
 * @version 1.0
 */
 ...
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>pen、filter任意一个为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @param filter 指向滤波器对象OH_Drawing_Filter的指针。
 * @since 12
 * @version 1.0
 */
 ...
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>pen、src、dst任意一个为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
 *
 * @param pen 指向画笔对象OH_Drawing_Pen的指针。
 * @param src 指向源路径对象OH_Drawing_Path的指针。
 * @param dst 指向目标路径对象OH_Drawing_Path的指针。
 * @param rect 指向矩形对象OH_Drawing_Rect的指针，推荐使用NULL，为NULL时不指定裁剪矩形。
 * @param matrix 指向矩阵对象OH_Drawing_Matrix的指针，推荐使用NULL，默认使用单位矩阵即不进行变换。
