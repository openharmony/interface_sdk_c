 ...
 *
 * @return 函数会返回一个指针，指针指向创建的区域对象OH_Drawing_Region。
 * @since 12
 * @version 1.0
 */
 ...
 * @brief 用于创建一个区域对象的拷贝。
 *
 * @param region 指向区域对象OH_Drawing_Region的指针。
 ...
 * <br>region为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
 *
 * @param region 指向区域对象OH_Drawing_Region的指针。
 * @param x 表示指定坐标点的x轴坐标，单位为物理像素px。
 * @param y 表示指定坐标点的y轴坐标，单位为物理像素px。
 ...
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>region、other任意一个为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER；
 * <br>op不在枚举范围内时返回OH_DRAWING_ERROR_PARAMETER_OUT_OF_RANGE。
 *
 * @param region 指向区域对象OH_Drawing_Region的指针，操作完成后的区域结果将会保存在此区域对象中。
 * @param other 指向参与合并操作的另一个区域对象OH_Drawing_Region的指针，
 * 将与region参数指定的区域按照op操作类型进行合并。
 * @param op 区域操作枚举类型，支持的可选模式见OH_Drawing_RegionOpMode枚举。
 ...
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>region、rect任意一个为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
 *
 * @param region 指向区域对象OH_Drawing_Region的指针。
...
/**
 * @brief 将区域对象设置为指定区域内路径表示的范围。
 * <br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。
 * <br>region、path、clip任意一个为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
 *
 * @param region 指向区域对象OH_Drawing_Region的指针。
 * @param path 指向路径对象OH_Drawing_Path的指针。
 * @param clip 指向作为裁剪区域的区域对象OH_Drawing_Region的指针。
 * @return 返回操作后的区域是否为空。true表示区域不为空，false表示区域为空。
 * @since 12
 * @version 1.0
 */
 ...
 *     <br>返回OH_DRAWING_ERROR_INCORRECT_PARAMETER，表示region是空指针。
 * @since 22
 * @version 1.0
 */
 ...
 *
 * @param region 指向区域对象OH_Drawing_Region的指针。
 * @param path 指向路径对象OH_Drawing_Path的指针。作为出参使用。
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INCORRECT_PARAMETER，表示region或path是空指针。
 * @since 23
 */
 ...
 *
 * @param region 指向区域对象OH_Drawing_Region的指针。
 * @param rect 指向矩形对象OH_Drawing_Rect的指针。作为出参使用。
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INCORRECT_PARAMETER，表示region或rect是空指针。
 * @since 23
 */
 ...
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INCORRECT_PARAMETER，表示region或isComplex是空指针。
 * @since 23
 */
 ...
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INCORRECT_PARAMETER，表示region或isEmpty是空指针。
 * @since 23
 */
 ...
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INCORRECT_PARAMETER，表示region或isRect是空指针。
 * @since 23
 */
 ...
 *
 * @param region 指向区域对象OH_Drawing_Region的指针。
 * @param left 表示指定矩形左上角的x轴坐标，单位为物理像素px。
 * @param top 表示指定矩形左上角的y轴坐标，单位为物理像素px。
 * @param right 表示指定矩形右下角的x轴坐标，单位为物理像素px。
 * @param bottom 表示指定矩形右下角的y轴坐标，单位为物理像素px。
 * @param isContained 指示该区域是否等同于单个矩形并且包含指定的矩形。作为出参使用。
 *     <br>true表示该区域等同于单个矩形并且包含指定的矩形，false表示该区域不等同于单个矩形或不包含指定的矩形。
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INCORRECT_PARAMETER，表示region或isContained是空指针。
 * @since 23
 */
 ...
 *     <br>true表示当前区域为空或与指定矩形不相交；false表示当前区域不为空且与指定矩形相交。
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INCORRECT_PARAMETER，表示region或isReject是空指针。
 * @since 23
 */
 ...
 *
 * @param region 指向区域对象OH_Drawing_Region的指针。
 * @param dx 表示在x轴上要平移的距离，单位为物理像素px。
 * @param dy 表示在y轴上要平移的距离，单位为物理像素px。
 * @return 函数返回执行结果。
 *     <br>返回OH_DRAWING_SUCCESS，表示执行成功。
 *     <br>返回OH_DRAWING_ERROR_INCORRECT_PARAMETER，表示region是空指针。
 * @since 23
